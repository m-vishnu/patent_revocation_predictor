...
df = pd.read_pickle("data/preprocessed/translated_tfidf.pkl")
...
with open('outputs/models/tfidf_grid_search_obj.pkl', 'wb') as f:
    pickle.dump(grid_search, f)

# save the best model
with open('outputs/models/tfidf_best_model.pkl', 'wb') as f:
...
feature_importances.to_csv("outputs/misc/feature_importances_xgb_feature_selected.csv", index=False)


dump_pickle(label_encoder, filepath='outputs/misc/label_encoder_tfidf.pkl')



dump_pickle(X_train, filepath='data/model_ready/tfidf/X_train.pkl')
dump_pickle(X_test, filepath='data/model_ready/tfidf/X_test.pkl')
dump_pickle(y_train, filepath='data/model_ready/tfidf/y_train.pkl')
dump_pickle(y_test, filepath='data/model_ready/tfidf/y_test.pkl')
